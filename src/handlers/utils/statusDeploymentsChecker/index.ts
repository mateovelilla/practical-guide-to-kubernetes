...
export class StatusDeploymentsCheckerHandler extends AbstractHandler {
    public async handle(request: Request) {
        try {
            ...
            while(loading) {
                const { stdout: outputStatusReplicas } =  await super.runCommand("kubectl",["get", "deployments", "-o", "json"])
